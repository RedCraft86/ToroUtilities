...
/**
 * Struct representing basic common properties across all light types.
 */
USTRUCT(BlueprintType)
struct TOROCORE_API FBaseLightProperties
{
    ...
    /**
     * Scales the contribution of this light to indirect lighting (GI).
     */
    ...
    /**
     * If enabled, this light can be processed by the MegaLights system (with Lumen).
     */
...
/**
 * Struct representing basic properties of a Point Light.
 */
USTRUCT(BlueprintType)
...
/**
 * Struct representing basic properties of a Spot Light.
 */
USTRUCT(BlueprintType)
...
/**
 * Struct representing basic properties of a Rect Light.
 */
USTRUCT(BlueprintType)
...
/**
 * Blueprint function wrappers for LightProperties struct functions
 */
