...
struct TORORUNTIME_API FWrappedBool final
{
	GENERATED_BODY()
 ...
 */
USTRUCT(BlueprintType)
struct TORORUNTIME_API FWrappedFloat final
{
	GENERATED_BODY()
 ...
 */
USTRUCT(BlueprintType)
struct TORORUNTIME_API FWrappedByte final
{
	GENERATED_BODY()
 ...
 */
USTRUCT(BlueprintType)
struct TORORUNTIME_API FWrappedInt32 final
{
	GENERATED_BODY()
 ...
 */
USTRUCT(BlueprintType)
struct TORORUNTIME_API FWrappedInt64 final
{
	GENERATED_BODY()
 ...
 */
USTRUCT(BlueprintType)
struct TORORUNTIME_API FWrappedString final
{
	GENERATED_BODY()
